		...
		<center><div class="container">
			...
			<article style="color:#FFFFFF;">
				<p>
					...
					<hr/>
					<center><h1>Add Bitcoin Spend/Sell</h1></center>
					<hr/>
					<p>
						...
						<div class="box">
							<p>
								This form allows you to add a record of a Bitcoin spend event.
							</p>
						</div>
						...
						<div class="box">
							...
							<?php
								...
								$bitcoin_spent_err = $exchange_rate_err = $date_err = "";
								$bitcoin_spent = $exchange_rate = "";
								$date = "";
								...
								if ($_SERVER["REQUEST_METHOD"] == "POST") 
								{
									...
									//{
										if (empty($_POST["bitcoin_spent"])) 
										{
											$bitcoin_spent_err = "An amount is required";
										}
										else
										{
											if(!is_numeric($_POST["bitcoin_spent"]))
											{
												$bitcoin_spent_err = "The amount must be numeric.";
											}
											else
											{
												if($_POST["bitcoin_spent"] > $result[4])
												{
													$bitcoin_spent_err = "You don't have that much! You have " . $result[4] . " &#x0E3F";
												}
												else
												{
													$bitcoin_spent = cleanInput($_POST["bitcoin_spent"]);
												}
											}
										}
										...
										if(empty($bitcoin_spent) or empty($exchange_rate) or empty($date))
										{
										...
										else
										{
											...
											add_spend($username, $bitcoin_spent, $date, $exchange_rate);
							...
							<center>
								...
								<center><table class="mainTable">
									<tr>
										...
										<td/>
										<td>
											<input type="text" name="bitcoin_spent" value="<?php echo $bitcoin_spent;?>" size="8"> &#x0E3F <!-- BTC symbol -->
											<span class="error">* <?php echo $bitcoin_spent_err;?></span>
										<td/>
									</tr>
									<tr>
										<td>
